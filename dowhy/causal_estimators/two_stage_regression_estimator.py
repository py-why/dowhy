        ...
        **kwargs,
        ...
        if first_stage_model is not None:
            if isinstance(first_stage_model, CausalEstimator):
                self._first_stage_model = first_stage_model.get_new_estimator_object(modified_target_estimand)
            else:
        ...
        if second_stage_model is not None:
            if isinstance(second_stage_model, CausalEstimator):
                self._second_stage_model = second_stage_model.get_new_estimator_object(modified_target_estimand)
            else:
