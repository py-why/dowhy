...
""" MNIST Causal, Independent and Causal+Independent datasets
    ...
    * Environments/domains stored in list self.datasets (should be true for all datasets)
...
class MNIST_Causal_Attribute(MultipleDomainDataset):
    N_STEPS = 5001
    CHECKPOINT_FREQ = 500
...
class MNIST_Ind_Attribute(MultipleDomainDataset):
    N_STEPS = 5001
    CHECKPOINT_FREQ = 500
...
class MNIST_Causal_Ind_Attribute(MultipleDomainDataset):
    N_STEPS = 5001
    CHECKPOINT_FREQ = 500
    ...
    def __init__(self, root):
        ...
        original_images = original_dataset_te.data
        original_labels = original_dataset_te.targets
        self.datasets.append(self.color_dataset(original_images, original_labels, environments[-1], angles[-1]))
