...
class BootstrapRefuter(CausalRefuter):
    ...
    - 'number_of_sumples': The number of bootstrap samples to be constructed
    - 'random_state': The seed value to be added if we wish to repeat the same random behavior. For this
    purpose, we repeat the same seed in the psuedo-random generator.
    """
