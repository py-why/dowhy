...
def mechanism_change_test(target_original_data: np.ndarray,
                          ...
                          = kernel_based) -> float:
    """Estimates a p-value for the nullhypothesis that the original and new data were generated by the same mechanism. 
    ...
    :return: A p-value for the nullhypothesis that the mechanism has not changed.
    """
