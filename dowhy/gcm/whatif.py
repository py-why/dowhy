...
def interventional_samples(
    ...
    :param random_seed: Optional seed for the random number generator. If provided, the seed is set before any
                        sampling takes place, making results reproducible across independent calls.
