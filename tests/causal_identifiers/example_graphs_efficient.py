...
TEST_EFFICIENT_BD_SOLUTIONS = {
    ...
    "sr22_fig2_diffcosts_example_graph": dict(
        ...
        optimal_adjustment_set=None,
        optimal_minimal_adjustment_set={"L", "T", "R"},
        optimal_minimum_cost_adjustment_set={"L", "T", "B"},
        costs=[
            ("L", {"cost": 1}),
            ("B", {"cost": 1}),
            ("K", {"cost": 4}),
    ...
    "sr22_fig3_example_graph": dict(
        ...
        conditional_node_names=[],
        optimal_adjustment_set={"R", "T"},
        optimal_minimal_adjustment_set={"R", "T"},
        optimal_minimum_cost_adjustment_set={"B", "Q"},
        costs=[
            ("B", {"cost": 1}),
            ("Q", {"cost": 1}),
            ("R", {"cost": 2}),
    ...
    "alldiff_example_graph": dict(
        ...
        conditional_node_names=[],
        optimal_adjustment_set={"O", "W7", "W8", "W9"},
        optimal_minimal_adjustment_set={"W7", "W8", "W9"},
        optimal_minimum_cost_adjustment_set={"W7", "W8", "W6"},
        costs=[
            ("W1", {"cost": 2}),
            ("W2", {"cost": 1}),
            ("W3", {"cost": 1}),
