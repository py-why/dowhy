...
from dowhy.gcm.constant import FALSIFY_N_TESTS, FALSIFY_N_VIOLATIONS
...
@flaky()
def test_PermuteNodes_exclude_original_order():
...
@flaky()
def test_PermuteNodes_include_original_order():
    num_nodes = np.random.randint(10)
...
@flaky(max_runs=5)
def test_validate_causal_graph_collider_correct_given():
    # collider: X->Z<-Y
...
@flaky(max_runs=5)
def test_validate_causal_graph_collider_wrong_given():
    # collider: X->Z<-Y
    true_dag = nx.DiGraph([("X", "Z"), ("Y", "Z")])
...
@flaky(max_runs=5)
def test_validate_causal_graph_chain_correct_given():
    # chain: X->Y->Z
...
@flaky(max_runs=5)
def test_validate_causal_graph_chain_wrong_given():
    # chain: X->Y->Z
    true_dag = nx.DiGraph([("X", "Y"), ("Y", "Z")])
...
@flaky(max_runs=5)
def test_validate_causal_graph_empty():
    # Empty graph
    dag = nx.DiGraph()
    data = pd.DataFrame()
    summary = validate_graph(
...
@flaky(max_runs=5)
def test_validate_causal_graph_full():
    # Full DAG
...
@flaky(max_runs=5)
def test_validate_causal_graph_single_node():
...
@flaky(max_runs=5)
def test_validate_causal_graph_single_edge_correct_given():
...
@flaky(max_runs=5)
def test_validate_causal_graph_single_edge_wrong_given():
    # DAG with single edge
...
@flaky(max_runs=5)
def test_validate_causal_graph_categorical_data():
    # chain: X->Z->Y
    dag = nx.DiGraph([("X", "Z"), ("Z", "Y")])
...
@flaky(max_runs=5)
def test_validate_causal_minimality_non_minimal_given():
...
@flaky(max_runs=5)
def test_validate_causal_minimality_minimal_given():
