...
from dowhy.gcm import auto, fit, kernel_based, refute_invertible_model, \
    refute_causal_structure, RejectionResult, InvertibleStructuralCausalModel
...
def test_refute_causal_structure_adjusted_p_values():
    ...
    assert rejection_summary['X']['local_markov_test']['fdr_adjusted_p_value'] \
           >= rejection_summary['X']['local_markov_test']['p_value']
    assert rejection_summary['X']['edge_dependence_test']['Z']['fdr_adjusted_p_value'] \
           >= rejection_summary['X']['edge_dependence_test']['Z']['p_value']
    assert rejection_summary['Y']['local_markov_test']['fdr_adjusted_p_value'] \
           >= rejection_summary['Y']['local_markov_test']['p_value']
    assert rejection_summary['Y']['edge_dependence_test']['Z']['fdr_adjusted_p_value'] \
