...
(see the :ref:`Understanding the method <understand-method>` section for more details).
...
Counterfactuals in graphical causal models are very similar to :doc:`simulate_impact_of_interventions`, with an important
